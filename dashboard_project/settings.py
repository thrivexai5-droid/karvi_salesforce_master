...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-=f9&jrdwmv9e(0_bogp3bsv$^7)cbx!b1slac69=-ncho@!e5j')
...
ALLOWED_HOSTS = [
    ...
    '127.0.0.1', 
    '*.pythonanywhere.com',
    os.getenv('ALLOWED_HOST', 'yourusername.pythonanywhere.com'),
]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'karvi_dashboard'),
